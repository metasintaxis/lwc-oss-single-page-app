...
practices as much as possible. In the future, we might use a forked package to
update the dependency tree if the official package doesn't receive new updates.
